    ...
    >
      <defs>
        <pattern id="grid" width="96" height="96" patternUnits="userSpaceOnUse">
          <path d="M 96 0 L 0 0 0 96" fill="none" stroke="#bf8900" strokeWidth="0.4" />
        </pattern>
      ...
      {[
        ...
        <g key={i}>
          <circle cx={cx} cy={cy} r="2" fill="#bf8900">
            <animate attributeName="opacity" values="0.2;0.85;0.2" dur="4s" begin={`${i * 0.5}s`} repeatCount="indefinite" />
          </circle>
          <circle cx={cx} cy={cy} r="14" fill="none" stroke="#bf8900" strokeWidth="0.4" opacity="0.25" />
        </g>
      ))}
      <path d="M 180 140 L 680 180 L 880 420 L 1260 680" stroke="#bf8900" strokeWidth="0.4" fill="none" opacity="0.3" />
      <path d="M 320 760 L 880 420 L 1400 220" stroke="#e6c230" strokeWidth="0.4" fill="none" opacity="0.2" />
    </svg>
  );
}
